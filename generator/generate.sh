...
#for i in 0 1 2 3 4 5 6; do
#	convert +antialias -font NewCenturySchlbk-Roman -pointsize 28 -kerning 2 -size 48x26 xc:white -fill black -draw text\ -3,20\ \"${days1[$i]}\" -draw text\ ${off2[$i]},20\ \"${days2[$i]}\" -draw text\ ${off3[$i]},20\ \"${days3[$i]}\" d$i.png
#done
